...
struct CustomTabBar: View {
            ...
            GeometryReader { proxy in
                ...
                Circle()
                    ...
                    .background(alignment: .top) {
                        Rectangle()
                            .fill(.linearGradient(colors: [Color("TabBG"),
                                                           Color("BG"),
                                                           Color("BG")],
                                                  startPoint: .top,
                                                  endPoint: .bottom))
                ...
                // Indicator
                    .background(content: {
                        ...
                        // 여기까지 indicator는 센터에 있으므로 Top으로 데려오자
                            .offset(y: -1.5)
    ...
    func calculateRotation(maxedWidth y: CGFloat, actualWidth: CGFloat, _ isInitial: Bool = false) -> CGFloat {
        ...
        // atan, atan2가 있는데 atan은 -90도 90도 사이를 atan2는 -180도 180도 사이의 rotation을 준다.
...
// 베지에 곡선 참고자료
// https://blog.coderifleman.com/2016/12/30/bezier-curves/index.html
